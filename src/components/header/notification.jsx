...
function Notification() {
  ...
  return (
    <>
      <button data-count={notys.length} className={notys.length > 0 ? "buttonNotification buttonNotificationCount" : "buttonNotification"} onClick={() => handleClick()} style={window.location.pathname === "/dashboard" ? { top: "97px" } : { top: "55px" }}>
      ...
      {notifyButtonState ? <NotificationWrapper notys={notys} /> : null}
    </>
  )
}

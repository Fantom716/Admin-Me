...
import NotificationAction from "../../notifications/action/action";
...
function Notification() {
    ...
    return (
        <>
            <button className={style.buttonNotification} onClick={ShowNotification} style={window.location.pathname === "/dashboard" ? {top: "97px"} : {top: "55px"}}>
